                ...
                <div class="tab-content">
                   ...
                   @endif 
                         <div class="step_21 center_c">
                            {!! Form::model($gef, ['method' => 'PATCH','route' => ['gonogo_store', $gef->gef_phone]]) !!}
                            ...
                            <span class="required"></span>   
                               {!! Form::label('19. Status') !!}
                                {{ Form::select('status', [
                                   ...
                                   'STA' => 'STA','Hot' => 'Hot'], $gonogo->gonogo_skilled, ['placeholder' => 'Select', 'class' => 'form-control', 'required' => '']
                                ) }}        
                          </div>
                         </div>
                       </div>
                ...
                Start of Step2 -->
                   ...
                   @endif
                         <div class="step_21 center_c">
                            ...
                            {!! Form::model($gef, ['route' => ['followup_store', $gef->gef_phone]]) !!}
                       <div class="row">
                          <div class="col-md-10">
                           <div class="form-group"> 
                            <span class="required"></span>   
                            ...
                            <span class="required"></span>   
                               {!! Form::label('3. Status') !!}
                                {{ Form::select('status', [
                                   ...
                                   'BEYOND' => 'BEYOND',
                                   'Onshore Lead' => 'Onshore Lead',
                                   'STA' => 'STA','Hot' => 'Hot','Drop Pending' => 'Dropped'], null, ['placeholder' => 'Select', 'class' => 'form-control', 'required' => '']
                                ) }}        
                          </div>
                         </div>
                       </div>
...
<br>
                           ...
                           {!! Form::label('Courses Finalized') !!}</br>
                            ...
                            <table class="tablesorter" id="keywords" cellspacing="0" cellpadding="0">
                              <thead>
                               ...
                               <tbody id="mchecks-list" name="mchecks-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_mchecks" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   <td></td>
                                   <td></td>
                                   <td></td>
                                   </tr>
                               ...
                               <tbody id="english1-list" name="english1-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_english1" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   <td></td>
                                   <td></td>
                                   <td></td>
                                   </tr>
                               ...
                               <tbody id="files-list" name="files-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_files" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                               ...
                               <tbody id="scan-list" name="scan-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_scan" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>  
                             </table> 
                            ...
                            @if($employeep->AJV_DEP_ID === '1')
                               <tbody id="passport-list" name="passport-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_passport" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody> 
                            @else
                               <tbody id="passportS-list" name="passportS-list">
                                   ...
                                   <td>{{ $outcome->outcome_passport_scan }}</td>
                                   <td>{{ $outcome->outcome_passport_ACO }}</td>
                                   <td><button class="btn btn-warning btn-detail open_modal_passportS" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @endif
                            @if($employeep->AJV_DEP_ID === '1')  
                               <tbody id="class10-list" name="class10-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_class10" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @else
                               <tbody id="class10S-list" name="class10S-list">
                                   ...
                                   <td>{{ $outcome->outcome_class10_scan }}</td>
                                   <td>{{ $outcome->outcome_class10_ACO }}</td>
                                   <td><button class="btn btn-warning btn-detail open_modal_class10S" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @endif
                            @if($employeep->AJV_DEP_ID === '1')
                               <tbody id="class12-list" name="class12-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_class12" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @else
                               <tbody id="class12S-list" name="class12S-list">
                                   ...
                                   <td>{{ $outcome->outcome_class12_scan }}</td>
                                   <td>{{ $outcome->outcome_class12_ACO }}</td>
                                   <td><button class="btn btn-warning btn-detail open_modal_class12S" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @endif
                            @if($employeep->AJV_DEP_ID === '1')
                               <tbody id="BC-list" name="BC-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_BC" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                           @else
                               <tbody id="BCS-list" name="BCS-list">
                                   ...
                                   <td>{{ $outcome->outcome_BC_scan }}</td>
                                   <td>{{ $outcome->outcome_BC_ACO }}</td>
                                   <td><button class="btn btn-warning btn-detail open_modal_BCS" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @endif
                            @if($employeep->AJV_DEP_ID === '1')
                               <tbody id="BSWM-list" name="BSWM-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_BSWM" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @else
                               <tbody id="BSWMS-list" name="BSWMS-list">
                                   ...
                                   <td>{{ $outcome->outcome_BSWM_scan }}</td>
                                   <td>{{ $outcome->outcome_BSWM_ACO }}</td>
                                   <td><button class="btn btn-warning btn-detail open_modal_BSWMS" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @endif
                            ...
                            @if($employeep->AJV_DEP_ID === '1')
                               <tbody id="BPC-list" name="BPC-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_BPC" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                           @else
                               <tbody id="BPCS-list" name="BPCS-list">
                                   ...
                                   <td>{{ $outcome->outcome_BPC_scan }}</td>
                                   <td>{{ $outcome->outcome_BPC_ACO }}</td>
                                   <td><button class="btn btn-warning btn-detail open_modal_BPCS" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                           @endif      
                            ...
                            @if($employeep->AJV_DEP_ID === '1')
                               <tbody id="BDC-list" name="BDC-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_BDC" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                           @else
                               <tbody id="BDCS-list" name="BDCS-list">
                                   ...
                                   <td>{{ $outcome->outcome_BDC_scan }}</td>
                                   <td>{{ $outcome->outcome_BDC_ACO }}</td>
                                   <td><button class="btn btn-warning btn-detail open_modal_BDCS" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                           @endif
                            ...
                            @if($employeep->AJV_DEP_ID === '1')
                               <tbody id="CV-list" name="CV-list">
                                   ...
                                   <td><button class="btn btn-warning btn-detail open_modal_CV" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                            @else 
                               <tbody id="CVS-list" name="CVS-list">
                                   ...
                                   <td>{{ $outcome->outcome_CV_scan }}</td>
                                   <td>{{ $outcome->outcome_CV_ACO }}</td>
                                   <td><button class="btn btn-warning btn-detail open_modal_CVS" value="{{$outcome->gef_phone}}">Edit</button></td>
                                   </tr>
                              </tbody>
                           @endif
       ...
       @if($outcome->outcome_status === null)  
</br>
</br>
</br>
          {!! Form::label('Send the lead enquiry for TL/Manager approval') !!}
          <table>
           <td>
                  <div class="form-group">
                   {!! Form::model($gef, ['method' => 'PATCH','route' => ['forApproval', $gef->gef_phone]]) !!}

                   <?php
                    $user = Auth::user();
                    $deptList = App\employee::where('AJV_EMP_Email','=',$user->email)->first();
                    $lead = App\sales_leads::where('sales_lead_id','=',$deptList->AJV_EMP_Lead)->first();
                    if($lead != null){
                       $empList  = App\employee::where('AJV_EMP_Email','=',$lead->sales_lead_email)->pluck('AJV_EMP_Fname', 'AJV_EMP_ID');
                    } else {
                       $empList  = App\employee::pluck('AJV_EMP_Fname', 'AJV_EMP_ID');
                    } 
                   ?>
                  {!! Form::select('forApproval', $empList, 0, ['placeholder' => 'Select Manager','class' => 'form-control', 'required' => '']) !!} 
                 </div>
                </td> 
               <td>&nbsp;&nbsp;&nbsp;</td>
              <td><input name="approval" value="Approval Pending" type="hidden">
           {{ Form::submit('For Approval', ['class' => 'btn btn-warning']) }}
           {{ Form::close() }}</td>
        </table>
      @else
</br>
          ...
          <?php
            $out =  App\outcome::where('gef_phone','=',$gef->gef_phone)->first(); 
            $emp  = App\employee::where('AJV_EMP_Email','=',$out->outcome_forApproval)->first();
            $user = Auth::user();
          ?>
        @if($emp != null)
         @if($user->email != $emp->AJV_EMP_Email)  
           {!! Form::open(array( 'class' => 'form-line', 'files' => true)) !!}    
           @if($outcome->outcome_status === 'Approval Pending') 
            {!! Form::label('Enquiry yet to be Approved by') !!}
           @else
            {!! Form::label('Enquiry Approved by') !!}
           @endif                                 
            {!! Form::label('forApproval', $emp->AJV_EMP_Fname, 
         array('class'=>'form-control')) !!}
           {{ Form::close() }}    
         @else
           @if($outcome->outcome_status === 'Approval Pending') 
        ...
        <div class="col-md-6">
         <div class="form-group">
           {!! Form::label('Approve the lead for service process') !!}
           {{ Form::select('status', [
              'Approved' => 'Approved'], null, ['placeholder' => 'Select', 'class' => 'form-control', 'required' => '']
           ) }}
         </div>
        </div>   
        <div class="col-md-6">
