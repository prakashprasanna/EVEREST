...
@if($visa === null)
                      ...
                      <div style='display:none; id='feesAware' class='feesAware'> 
                       <div class="row">
                          <div class="col-md-10">
                           <div class="form-group"> 
                            <span class="required"></span>   
                           {!! Form::label('Comments!!!!') !!}
                               {!! Form::textarea('fees_notes', null, 
                                        array('class'=>'form-control', 
                                        'placeholder'=>'comments')) 
                               !!}                   
                          </div>
                       ...
                       <div class="row">
                          <div class="col-md-10">
                           ...
                           {!! Form::label('If personal savings then are they 6 months old?') !!}
                                {{ Form::select('savings', [
                                   'Yes' => 'Yes',
                                   'No' => 'No'], $admission->admission_saveOld, ['placeholder' => 'Select', 'class' => 'form-control','id' => 'stat']
                                ) }}                   
                          </div>
                         </div>
                       </div>
